...
<div style="display: flex; flex-direction: column; gap: 20px;">
  ...
  <div id="introduction" style="background-color: #f8f9fa; padding: 20px; border-radius: 10px;">
    ...
    <h3>Resources</h3>
    <p><a href="https://github.com/decoding-the-AI-pen/decoding-the-AI-pen.github.io/blob/main/assets/slides/DecodingtheAIPen.pdf" download="DecodingtheAIPen.pdf">Download Slides</a></p>
  </div>
