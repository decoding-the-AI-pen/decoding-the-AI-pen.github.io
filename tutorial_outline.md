...
<div style="display: flex; flex-direction: column; gap: 20px;">
  ...
  <div id="part-i-risks-and-misuse-of-ai-generated-text" style="background-color: #f8f9fa; padding: 20px; border-radius: 10px;">
  ...
  <div id="part-ii-ai-generated-text-detection-techniques" style="background-color: #f8f9fa; padding: 20px; border-radius: 10px;">
  ...
  <div id="part-iii-vulnerabilities-of-detection-techniques" style="background-color: #f8f9fa; padding: 20px; border-radius: 10px;">
  ...
  <div id="part-iv-theoretical-perspective-on-the-possibility-of-detection" style="background-color: #f8f9fa; padding: 20px; border-radius: 10px;">
  ...
  <div id="conclusion-and-future-directions" style="background-color: #f8f9fa; padding: 20px; border-radius: 10px;">
